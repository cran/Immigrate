...
// [[Rcpp::export]]
List imIM4ECpp(Function oneimIM4E,NumericMatrix train_xx,NumericVector train_yy,double epsilon=0.01,
       double sig=1,double rho=1,double lambda=1,int max_iter=10,bool removesmall=false){
